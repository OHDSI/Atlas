							...
							.then(async () => {
								...
								for (var s = 0; s < cdmSources.length; s++) {
									...
									if (sourceInfo != null) {
										...
										cdsi.startTime = ko.observable(momentUtils.formatDateTime(date));
										cdsi.executionDuration = ko.observable(momentUtils.formatDuration(sourceInfo.executionDuration));
