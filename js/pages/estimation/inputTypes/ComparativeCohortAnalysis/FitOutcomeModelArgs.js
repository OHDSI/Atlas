define([
	...
	class FitOutcomeModelArgs extends RLangClass {
        constructor(data = {}) {
            ...
            this.control = data.control === undefined ? new Control({cvType: "auto", startingVariance: 0.01, tolerance: .0000002, cvRepetitions: 10, noiseLevel: "quiet"}) : new Control(data.control);
        }
	}
