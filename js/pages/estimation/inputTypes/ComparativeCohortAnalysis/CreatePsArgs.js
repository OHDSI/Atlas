define([
	...
	function CreatePsArgs(data) {
        ...
        self.errorOnHighCorrelation = ko.observable(data.errorOnHighCorrelation === undefined ? true : data.errorOnHighCorrelation);
        self.stopOnError = ko.observable(data.stopOnError === undefined ? true : data.stopOnError);
