define([
  ...
  class ConceptsetLockHistory extends AutoBind(Component) {
    constructor(params) {
      ...
      // { title: ko.i18n('columns.conceptName', 'Concept Name'), render: $component.commonUtils.renderBoundLink},
      ...
      this.expressionItemColumns = [
        ...
        //   class: 'text-center',
        //   orderable: false,
        //   render: () => renderers.renderCheckbox('isSelected', false),
        // },
        {
    ...
    async loadConceptSetSnapshotDetails(tabIndex) {
      // Assume fetchSnapshotIncludedConcepts and fetchSnapshotIncludedSourceCodes are implemented
      this.isLoading(true);
      try {
        let data;
        if (tabIndex === 1) {
        ...
        // Assuming the component can automatically re-render upon data update
    ...
    async loadTabData() {
      ...
      try {
        ...
        this.isLoading(false); // Ensure loading is disabled after data fetch
      } catch (error) {
