define(['jquery','knockout', 'text!./ConceptPickerTemplate.html', './InputTypes/Concept', 'vocabularyprovider', 'knockout-jqueryui/dialog'], function ($, ko, template, Concept, VocabularyProvider) {
