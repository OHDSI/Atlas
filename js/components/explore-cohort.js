define(['knockout', 'text!./explore-cohort.html', 'd3', 'atlas-state', 'appConfig', 'webapi/AuthAPI', 'lodash', 'crossfilter', 'd3-tip', 'databindings', 'components/faceted-datatable-cf-profile', 'css!exploreCohort.css'],
