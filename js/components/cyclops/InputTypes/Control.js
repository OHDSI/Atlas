...
function (
	...
	class Control extends RLangClass {
        constructor(data = {}) {
            ...
            this.seed = ko.observable(data.seed === 0 ? null : data.seed || null);
            this.resetCoefficients = ko.observable(data.resetCoefficients === 0 ? false : data.resetCoefficients || false);
            this.startingVariance = ko.observable(data.startingVariance === 0 ? -1 : data.startingVariance || -1).extend({numeric: 0});
            ...
            this.initialBound = ko.observable(data.initialBound === 0 ? 2 : data.initialBound || 2).extend({numeric: 0});
