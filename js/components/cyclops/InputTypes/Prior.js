define([
	...
	function Prior(data) {
        ...
        self.variance = ko.observable(data.variance === 0 ? 1 : data.variance || 1).extend({numeric: 0});
        self.exclude = ko.observable(data.exclude === 0 ? 0 : data.exclude || 0).extend({numeric: 0});
