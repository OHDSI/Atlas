define(['knockout', 'text!./cohort-comparison-browser.html', 'appConfig', 'moment', 'webapi/AuthAPI', 'access-denied', 'cohortcomparison/ComparativeCohortAnalysis','faceted-datatable'], function (ko, view, config, moment, authApi) {
