define(['knockout', 'jquery', 'text!./plp-browser.html', 'appConfig', 'webapi/MomentAPI', 'd3', 'webapi/PatientLevelPredictionAPI'], function (ko, $, view, config, momentApi, d3, plpAPI) {
