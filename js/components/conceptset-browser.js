define(['knockout', 'text!./conceptset-browser.html', 'faceted-datatable'], function (ko, view) {
	function conceptsetBrowsre(params) {
		var self = this;
		self.services = params.services;
		self.currentService = ko.observable();
		self.reference = ko.observableArray();
		self.selected = params.conceptsetSelected;
