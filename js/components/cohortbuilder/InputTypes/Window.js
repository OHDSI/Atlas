define(['knockout'], function (ko) {
	...
	function Window(data) {
		...
		self.Start = {
			...
			TimeUnitValue: ko.observable((data.Start && data.Start.TimeUnitValue) === 0 ? 0 : (data.Start && data.Start.TimeUnitValue)|| null)
		};
		...
		self.End = {
			...
			TimeUnitValue: ko.observable((data.End && data.End.TimeUnitValue) === 0 ? 0 : (data.End && data.End.TimeUnitValue) || null)
		};
