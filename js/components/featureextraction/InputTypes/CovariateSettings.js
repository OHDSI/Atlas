define(['knockout'], function (ko) {
	...
	function CovariateSettings(data) {
        ...
        self.longTermStartDays = ko.observable(data.longTermStartDays === 0 ? false : data.longTermStartDays || -365);
        self.mediumTermStartDays = ko.observable(data.mediumTermStartDays === 0 ? false : data.mediumTermStartDays || -180);
        self.shortTermStartDays = ko.observable(data.shortTermStartDays === 0 ? false : data.shortTermStartDays || -30);
        self.endDays = ko.observable(data.endDays === 0 ? false : data.endDays || 0);
