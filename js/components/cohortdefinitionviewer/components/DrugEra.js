define(['knockout','components/cohortbuilder/options','components/cohortbuilder/utils','components/cohortbuilder/InputTypes/Range', 'text!./DrugEraTemplate.html'], function (ko, options, utils, Range, template) {
