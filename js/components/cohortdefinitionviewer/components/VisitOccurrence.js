define(['knockout','components/cohortbuilder/options','components/cohortbuilder/utils','components/cohortbuilder/InputTypes/Range', 'text!./VisitOccurrenceTemplate.html'], function (ko, options, utils, Range, template) {
